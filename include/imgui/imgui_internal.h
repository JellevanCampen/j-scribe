...
namespace ImGui
{
    ...
    IMGUI_API void          RenderTextColor(ImVec2 pos, const char* text, const char* text_end = NULL, const ImVec4& color = ImVec4(0.f, 0.f, 0.f, 1.f), bool hide_text_after_hash = true);
    IMGUI_API void          RenderTextWrapped(ImVec2 pos, const char* text, const char* text_end, float wrap_width);
    IMGUI_API void          RenderTextWrappedColor(ImVec2 pos, const char* text, const char* text_end, float wrap_width, const ImVec4& color = ImVec4(0.f, 0.f, 0.f, 1.f));
    IMGUI_API void          RenderTextClipped(const ImVec2& pos_min, const ImVec2& pos_max, const char* text, const char* text_end, const ImVec2* text_size_if_known, const ImVec2& align = ImVec2(0,0), const ImRect* clip_rect = NULL);
    IMGUI_API void          RenderTextClippedColor(const ImVec2& pos_min, const ImVec2& pos_max, const char* text, const char* text_end, const ImVec2* text_size_if_known, const ImVec2& align = ImVec2(0, 0), const ImRect* clip_rect = NULL, const ImVec4& color = ImVec4(0.f, 0.f, 0.f, 1.f));
    ...
    IMGUI_API void          RenderTriangleColor(ImVec2 pos, ImGuiDir dir, float scale = 1.0f, const ImVec4& color = ImVec4(0.f, 0.f, 0.f, 1.f));
